...
class Pan_Control_Listener(Leap.Listener):  #The Listener that we attach to the controller. This listener is for palm tilt movement
    def __init__(self, mouse):
        super(Pan_Control_Listener, self).__init__()  #Initialize like a normal listener
